...
from infra.zk.interface import ZKInterface
from infra.pg.interface import V2VPGInterface, ZonePGInterface
from infra.redis.interface import V2VRedisInterface
from platforms.iaas.interface import IAASInterface
from utils.common.common import singleton
...
class WorkerContext(object):
    ...
    def __init__(self):
        self._config = Config(default_config=DEFAULT_CONFIG)
        self._redis = None
        self._zk = None
        self._v2v_pg = None
        self._zone_pg = None
    ...
    def server_conf(self):
        return self.config.get("server.conf", {})
